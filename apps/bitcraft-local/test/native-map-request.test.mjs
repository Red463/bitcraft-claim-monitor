...
test("native map requests are same-origin, canonical, and omit empty bounded layers", () => {
  ...
  assert.equal(request.snapshotUrl, "/api/local/map/snapshot?regions=19%2C24&layers=claims%2Cempire-settlements%2Cempire-territory%2Cenemies%2Cmarkets%2Cplayers%2Cwatchtowers%2Cwaystones&playerIds=216172782115643288&enemyTypes=1%2C8");
