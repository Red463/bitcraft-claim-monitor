...
test("unknown contribution aggregates are excluded from player views and counted for admins", () => {
  ...
  const partition = visibilityModule.partitionCraftContributionRows([
    ...
    { contribution_key: "owner", contributor_entity_id: "11", attribution_confidence: "owner_fallback", contributed_progress: "100" },
  ...
  assert.deepEqual(partition.adminDiagnostics, { unknownAttributionCount: 2 });
});
