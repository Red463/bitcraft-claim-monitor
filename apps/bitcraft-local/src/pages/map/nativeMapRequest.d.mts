export type NativeMapRequestInput = { operationalRegionIds?: string[]; playerRegionIds?: string[]; resourceRegionIds?: string[]; playerIds?: string[]; resourceIds?: string[]; enemyTypes?: string[] };
