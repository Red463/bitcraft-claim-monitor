...
export function enemyFeatureColour(
  feature: { identity?: unknown } | null | undefined,
  enemyColours: Readonly<Record<string, string | undefined>> | null | undefined,
): string;
...
export function selectedEnemyColourMap(
  enemyTypes: readonly unknown[],
  catalogByToken: {
    get(token: string): { tier?: unknown } | undefined;
  } | null | undefined,
): Record<string, string>;
