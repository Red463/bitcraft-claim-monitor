      ...
      {currentTab === "overview" ? (
        ...
        <>
          ...
          <section className="dashboard-card table-panel">
            ...
            <p className="hexite-reserve-note"><Zap size={14} /> Live known minimum includes the Empire treasury and completed Foundry Capsules; player and claim inventories remain unavailable.</p>
