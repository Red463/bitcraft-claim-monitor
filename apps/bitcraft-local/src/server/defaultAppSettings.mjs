...
export function defaultAppSettingRows({ serverRefreshSeconds, updatedAt }) {
  return [
    ...
    settingRow("operational_history_retention_enabled", "false", updatedAt),
    settingRow("operational_history_retention_days", "365", updatedAt),
    settingRow("operational_history_retention_tables_json", JSON.stringify([]), updatedAt),
