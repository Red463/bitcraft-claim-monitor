    ...
    <section className="form-card discord-channel-card bot-community-card">
      ...
      <div className="discord-panel-grid">{rolePanels.map((panel) => (
        <div className="discord-panel-editor" key={panel.key}>
          <div className="split-header"><h4>{panel.label}</h4><button className="toolbar-button bot-post-button" onClick={() => onPostPanel(panel.key, panel.label)}><MessageCircle size={14} /> Post/Update</button></div>
